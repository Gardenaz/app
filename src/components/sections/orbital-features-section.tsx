...
export const timelineData = [
  {
    ...
    title: "Live activity",
    date: "As it happens",
    content: "Watch the agent move from plan to execution without losing sight of what is being changed in the garden account.",
    category: "Execution",
    icon: Radio,
    relatedIds: [2, 3],
  ...
  },
  {
    ...
    date: "Always on",
    content: "Garden account, policy, execution, and proof work together so the user sees one clear flow instead of scattered tools.",
    category: "Network",
    icon: Network,
    relatedIds: [2, 5, 6],
    status: "completed" as const,
