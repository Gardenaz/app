...
interface YieldCardHeroProps extends React.HTMLAttributes<HTMLDivElement> {
  title: string;
  subtitle: string;
  cta: string;
  onCtaClick?: () => void;
      ...
      >
        ...
        >
          <div className="flex items-center gap-2">
            <div className="flex size-7 items-center justify-center rounded-lg bg-[#B3DF46]/20">
              <TrendingUp className="size-3.5 text-[#B3DF46]" />
            </div>
        ...
        >
          ...
          <div className="flex items-center gap-1">
            <div className="h-1 flex-1 rounded-full bg-[#B3DF46]/30">
              <div className="h-full w-3/4 rounded-full bg-[#B3DF46]" />
            </div>
        ...
        <div className="relative z-20 w-full text-left">
          <div className="mb-3 inline-flex items-center gap-1.5 rounded-full border border-[#B3DF46]/30 bg-[#B3DF46]/10 px-3 py-1">
            <Sprout className="size-3 text-[#B3DF46]" />
            <span className="text-[10px] font-bold tracking-wider text-[#B3DF46]">AGENT OUTPUT</span>
          </div>
          ...
          <div className="mt-5">
            ...
            <div className="h-1.5 overflow-hidden rounded-full bg-white/10">
              <motion.div
                className="h-full rounded-full bg-gradient-to-r from-[#B3DF46] to-[var(--primary)]"
                initial={{ width: 0 }}
          ...
          <div className="mt-5 flex items-center justify-between">
            ...
            <button
              onClick={onCtaClick}
              className="group flex items-center gap-1.5 rounded-lg bg-white px-4 py-2 text-xs font-bold text-[#0e1a10] transition-all duration-300 hover:bg-white/90"
            >
              {cta}
